...
Generated by 'django-admini startproject' using Django 3.0.5.
...
SECRET_KEY = '92=7z_jj)gb^=xt3qtpm66kfo9411-1h+9)5f%=q$zcj+b1uv&'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), '/templates/trainee/archs/' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
